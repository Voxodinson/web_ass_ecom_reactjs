...
<>
            ...
            <div className="row">
                ...
                <div key={product.id} className="col-sm-6 col-md-4 col-lg-4">
                    ...
                    <div className="option_container">
                        ...
                        <a href="option1" className="option1">
                            Add To Cart
                        </a>
                        <a href="option2" className="option2">
                            Buy Now
                        </a>
                        </div>
                    </div>
  ...
  {/* footer end */}
  <div className="cpy_">
    <p className="mx-auto">© Yon longdy 2024 <a href="https://html.design/"> design Webside using React.</a><br />
      Bootstrap <a href="https://themewagon.com/" target="_blank">To React</a>
    </p>
  </div>
</>
